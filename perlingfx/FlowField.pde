class FlowField {
  ...
  void display() {
   ...
   // fill(0);
         fill(((field[i][j].x * 255) + (field[i][j].y*255))/2);
       // fill(((field[i][j].z*255)));
      ellipse(i*resolution, j*resolution, (field[i][j].x *20 - field[i][j].y *20),(field[i][j].x *20 - field[i][j].y *20));
      }
    }
